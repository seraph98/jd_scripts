...
var options = {
	url: 'https://m.weibo.cn/c/checkin/ug/score/claim?action_id=132&st=0904df',
	headers: headers
};
...
function callback(error, response, body) {
	if (!error && response.statusCode == 200) {
		...
		console.log(body);
		notify.sendNotify(`微博`, `渔场签到领取50积分失败, error: ${error}, response: ${response}, body: ${body}`);
	}
}
