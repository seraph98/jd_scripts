...
var headers = {
	'Host': 'api.weibo.cn',
	'x-validator': 'HxcgmCX9IdFCmams3cjYaZBbfN0VGsoGPdU0yaDQF6k=',
	'x-log-uid': '5893064675',
	'x-sessionid': 'c0c02a9e-63dd-4c44-a35d-fb1bc899f42a',
...
var options = {
	url: 'https://api.weibo.cn/2/2/!/fish/signin_done?fromx=popup&type=&t_token=&networktype=wifi&accuracy_level=0&launchid=10000365--x&ul_hid=480ae1a1-5774-42d9-83d8-9a2b2917e91a&ul_sid=480ae1a1-5774-42d9-83d8-9a2b2917e91a&moduleID=700&wb_version=5558&c=android&s=af081de3&ft=0&ua=Xiaomi-M2010J19SC__weibo__12.4.3__android__android7.1.2&wm=5091_0008&aid=01A_yZCDo2-5dTP1htkqrGC3uYac7yJsPsI2Q1_NzOgslscBI.&v_f=2&v_p=90&from=10C4395010&gsid=_2A25PdvkODeRxGeNG4lER9irKzDmIHXVqIgvGrDV6PUJbkdCOLW3bkWpNSu-zpgOXrzTx16EAeW2QpG-RhhZPaYq5&lang=zh_CN&skin=default&oldwm=5091_0008&sflag=1&android_id=dc07f689504aad74&ul_ctime=1651673466035&cum=C4CC1867',
	headers: headers
};
...
function callback(error, response, body) {
	if (!error && response.statusCode == 200) {
		...
		notify.sendNotify(`微博渔场`, `签到失败, error: ${error}, response: ${response}, body: ${body}`);
	}
}
