...
##############短期活动##############
# 女装盲盒
35 1,5,15,17,22 * * * node /scripts/jd_nzmh.js >> /scripts/logs/jd_nzmh.log 2>&1
...
30 1,4,8,9,22,23 * * * node /scripts/jd_daily_lottery.js >> /scripts/logs/jd_daily_lottery.log 2>&1
# 金榜创造营 活动时间：2021-05-21至2021-12-31
0 1,10,19,22 * * * node /scripts/jd_gold_creator.js >> /scripts/logs/jd_gold_creator.log 2>&1
...
# 众筹许愿池
20 0,2,19,22 * * * node /scripts/jd_wish.js >> /scripts/logs/jd_wish.log 2>&1
# 内容鉴赏官
15 1,2,5,7 * * * node /scripts/jd_connoisseur.js >> /scripts/logs/jd_connoisseur.log 2>&1
# 母婴-跳跳乐
1 0,1,5,11,21 * * * node /scripts/jd_jump.js >> /scripts/logs/jd_jump.log 2>&1
# 逛京东会场
0 0,1,3,5 * * * node /scripts/jd_mall_active.js >> /scripts/logs/jd_mall_active.log 2>&1
# 京喜领88元红包
...
# 京东汽车旅程赛点兑换金豆
0 0,4,19 * * * node /scripts/jd_car_exchange.js >> /scripts/logs/jd_car_exchange.log 2>&1
# 导到所有互助码
