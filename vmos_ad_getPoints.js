...
var headers = {
	...
	'device-free-memory': '128384307200',
...
var options = {
	url: 'https://vproapi.vmos.cn/vmospro/login/userPoints/lookAdGetPoints?s=66f5def1651abb11db71a6daeb7763c9&k=eb759cd6d8e975ec29b999b743123721&auth_ver=2&n=1645161529838&u=2F5F446757D46DD6096FD1DFCE4C197F785977E5&c=app&v=10900&umid=19ebf73091f88d84e2e991371e21b9f6&mp=15305562330&at=A3864FAF313103B85BB2AB9A2D12A006&pb=Xiaomi&pm=MI%206%20Plus&sv=6.0.1&openid=oDRYU1Fdd1xy9Bee6V92VVAYqVFc&qqopenid=&userId=1014998&isVip=false',
	method: 'POST',
	headers: headers
};
...
function callback(error, response, body) {
	if (!error && response.statusCode == 200) {
		...
		notify.sendNotify(`vmos 看广告`, `看广告失败, error: ${error}, response: ${response}, body: ${body}`);
	}
}
